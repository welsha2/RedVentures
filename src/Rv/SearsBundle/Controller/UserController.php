...
use Rv\SearsBundle\Entity\User;
use Rv\SearsBundle\Form\UserType;
...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('RvSearsBundle:User')->findAll();
     ...
     * @Method("POST")
     * @Template("RvSearsBundle:User:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('RvSearsBundle:User')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("RvSearsBundle:User:edit.html.twig")
     */

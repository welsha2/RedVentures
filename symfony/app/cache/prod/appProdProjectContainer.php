...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'rm -rf symfony', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_fd803238038c9f3ccb14acca97f9a5eced6b9f991f49532a407a19190ae272c0');
        return $instance;
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56d0a7a626af4')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'assetic.node.bin' => ($this->targetDirs[5].'/.nvm/versions/node/v4.1.1/bin/node'),
            'assetic.ruby.bin' => '/usr/local/rvm/rubies/ruby-2.2.1/bin/ruby',
            'assetic.sass.bin' => '/usr/local/rvm/gems/ruby-2.2.1/bin/sass',
